...
@register_model('multilingual_fconv')
class MultilingualFconvModel(FairseqMultiModel):
    ...
    def build_model(cls, args, task):
        ...
        def get_encoder(lang):
            if lang not in lang_encoders:
                ...
                # lang_encoders[lang] = FConvEncoder(args, task.dicts[lang], encoder_embed_tokens)
                lang_encoders[lang] = FConvEncoder(args, task.dicts[lang], encoder_embed_tokens, embed_dim=args.encoder_embed_dim)
        ...
        def get_decoder(lang):
            if lang not in lang_decoders:
                ...
                lang_decoders[lang] = FConvDecoder(args, task.dicts[lang], decoder_embed_tokens, out_embed_dim=args.decoder_embed_dim)
        ...
        return MultilingualFconvModel(encoders, decoders)
...
@register_model_architecture('multilingual_fconv', 'multilingual_fconv')
...
@register_model_architecture('multilingual_fconv', 'multilingual_fconv_pg')
def multilingual_fconv_wiki(args):
    ...
    args.encoder_out_embed_dim = getattr(args, 'encoder_out_embed_dim', 256)
    base_multilingual_architecture(args)

# @register_model_architecture('multilingual_fconv', 'multilingual_fconv_wiki')
...
# @register_model_architecture('multilingual_transformer', 'multilingual_transformer_wiki')
# def multilingual_transformer_iwslt_de_en(args):
#     args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
