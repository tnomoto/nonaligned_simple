    ...
    def build_model(cls, args, task):
        ...
        def get_encoder(lang):
            if lang not in lang_encoders:
                ...
                lang_encoders[lang] = LSTMEncoder(args, task.dicts[lang], pretrained_embed=encoder_embed_tokens)
        ...
        def get_decoder(lang):
            if lang not in lang_decoders:
                ...
                lang_decoders[lang] = LSTMDecoder(args, task.dicts[lang], pretrained_embed=decoder_embed_tokens)
...
@register_model_architecture('multilingual_lstm', 'multilingual_lstm_wiki')
def multilingual_lstm_wiki(args):
