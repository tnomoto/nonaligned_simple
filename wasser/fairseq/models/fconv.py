...
class FConvEncoder(FairseqEncoder):
    ...
    def __init__(
        self, args, dictionary, embed_tokens, embed_dim=512, embed_dict=None, max_positions=1024,
        convolutions=((512, 3),) * 20, dropout=0.1,
    ):
        super().__init__(dictionary)
        self.dropout = dropout
        # self.num_attention_layers = None
        self.num_attention_layers = 1.0
...
class FConvDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(
        self,args, dictionary, embed_tokens, embed_dim=512, embed_dict=None, out_embed_dim=256,
    ...
    def forward(self, prev_output_tokens, encoder_out=None, incremental_state=None, **unused):
        ...
        return x, avg_attn_scores, extra
