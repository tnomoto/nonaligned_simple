...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--cnn-model', type=None, 
                            help='cnn model for use')
...
# class TransformerDecoderCNN(FairseqIncrementalDecoder):
...
#         # self.cnn = SimpleCNN(len(dictionary))
#         self.dropout = args.dropout
...
#         # print("transformer decoder out shape {}".format(x.size()))
